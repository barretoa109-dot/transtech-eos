/**
 * Dar de alta REGISTRAR_MOVIMIENTO_PERSONAL y la regla de ámbito.
 *
...
import { aplicar } from "./cambios-ambito-personal.mjs";
...
// ------------------------------------------------------------------- nodo 06
const RUTA_VIEJA = `  REGISTRAR_GASTO_FIJO: 'eos-worker-rc1-internal'
};`;

const RUTA_NUEVA = `  REGISTRAR_GASTO_FIJO: 'eos-worker-rc1-internal',

  /*
    La plata de la persona. Va al mismo worker: lo que cambia es la tabla y el
    ámbito, no el camino.
  */
...
if (http.parameters.jsonBody.includes("REGISTRAR_MOVIMIENTO_PERSONAL")) {
  throw new Error("El prompt ya menciona REGISTRAR_MOVIMIENTO_PERSONAL. No se escribió nada.");
}
