/**
 * Que el chat distinga una devolución de un ingreso.
 *
 *     node n8n/parches/2026-09-08-devolucion.mjs
 *
 * Solo toca el prompt: la acción es la que ya existe. Ver
 * `cambios-devolucion.mjs` y la migración v141.
 */
...
import { aplicar } from "./cambios-devolucion.mjs";
...
if (http.parameters.jsonBody.includes("DEVOLUCION es plata")) {
