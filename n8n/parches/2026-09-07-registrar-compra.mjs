/**
 * Dar de alta REGISTRAR_COMPRA y REGISTRAR_GASTO_FIJO en el workflow del chat.
 *
...
import { aplicar } from "./cambios-registrar-compra.mjs";
...
// ------------------------------------------------------------------- nodo 06
const RUTA_VIEJA = `  ACTUALIZAR_PRODUCTO: 'eos-worker-rc1-internal'
};`;

const RUTA_NUEVA = `  ACTUALIZAR_PRODUCTO: 'eos-worker-rc1-internal',

  /*
    La plata que sale, y la que se va a repetir. Las dos dejan efecto durable
    como las otras, así que van por el mismo camino interno.
  */
...
if (http.parameters.jsonBody.includes("REGISTRAR_COMPRA")) {
  throw new Error("El prompt ya menciona REGISTRAR_COMPRA. No se escribió nada.");
}
