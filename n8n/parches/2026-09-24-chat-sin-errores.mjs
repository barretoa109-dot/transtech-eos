/**
 * Los errores del chat del 24/09/2026, del lado de n8n.
 *
 *     SECO=1 node n8n/parches/2026-09-24-chat-sin-errores.mjs   (prueba: no escribe)
 *     node n8n/parches/2026-09-24-chat-sin-errores.mjs          (escribe)
 *
 * Solo el gateway:
 *   - "06 GW Preparar Jobs Worker": dos acciones del mismo tipo ya no chocan
 *     en el Worker Gate (`cambios-acciones-repetidas.mjs`).
 *   - "HTTP Request" (el prompt): la memoria se guarda en silencio
 *     (`cambios-memoria-silenciosa.mjs`).
 *
 * No depende de ninguna migración. Después de aplicar:
 *
...
import { aplicar } from "./cambios-acciones-repetidas.mjs";
import { aplicarPrompt } from "./cambios-memoria-silenciosa.mjs";
