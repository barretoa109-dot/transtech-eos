...
const financialAutopilotMenuItem = {
  title: "Finanzas",
...
export default function DashboardSidebar({
  ...
  const menu = showFinancialAutopilot
    ? [
        ...baseMenu.slice(0, 2),
        financialAutopilotMenuItem,
        ...baseMenu.slice(2),
      ]
    : baseMenu;
    ...
    <aside className="flex h-screen w-72 flex-col border-r border-slate-800 bg-slate-950">
      ...
      <div className="border-b border-slate-800 px-6 py-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-lg font-black text-white">TransTech</h2>

            <p className="text-xs text-slate-500">Enterprise OS</p>
          </div>
        </div>
      </div>
          ...
          <>
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate font-bold text-white">{nombre}</p>
