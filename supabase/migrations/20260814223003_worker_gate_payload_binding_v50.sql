...
begin
  ...
  if command_row.payload is distinct from approval.payload_snapshot then
...
comment on function public.eos_consume_action_approval_v12(uuid, uuid) is
  'RC1 v50: consume una aprobación one-shot sólo si command_id coincide en propietario, request_id, acción, estado ejecutable y payload exacto aprobado.';
