-- La rama de REGISTRAR_MOVIMIENTO_PERSONAL en el ejecutor.
--
-- Se genera desde el archivo de la v134 con tres cambios y nada más:
--
--   1. 'REGISTRAR_MOVIMIENTO_PERSONAL' entra en la lista de soportadas.
--   2. La rama nueva, que delega en
--      `eos_finanzas_registrar_personal_v136`.
--   3. `executor_version` pasa a 'v136'.
--
-- El porqué está en la cabecera de
-- `20260907270000_eos_ambito_personal_v136.sql`: la plata del negocio y la
-- de la persona compartían tabla, y la inversión de un negocio de
-- porcicultura terminó adentro del panel que contesta "¿estoy bien?" sobre
-- las finanzas personales.
--
-- Como en las anteriores, la función se genera desde el archivo previo en
-- vez de transcribirse: son diez ramas.
