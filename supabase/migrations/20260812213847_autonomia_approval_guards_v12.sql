...
drop trigger if exists eos_action_approvals_user_guard_v12 on public.eos_action_approvals_v12;
create trigger eos_action_approvals_user_guard_v12
before update on public.eos_action_approvals_v12
for each row execute function public.eos_guard_user_approval_update_v12();
...
drop trigger if exists eos_action_approvals_log_decision_v12 on public.eos_action_approvals_v12;
create trigger eos_action_approvals_log_decision_v12
after update on public.eos_action_approvals_v12
for each row execute function public.eos_log_approval_decision_v12();
