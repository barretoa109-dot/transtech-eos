...
comment on function public.eos_reserve_message_quota_v40(uuid) is
  'RC1 v41: reserva de cuota anti-replay; request reserved bloquea ejecución duplicada, consumed no puede reutilizarse y released sí puede reservarse tras un fallo.';
