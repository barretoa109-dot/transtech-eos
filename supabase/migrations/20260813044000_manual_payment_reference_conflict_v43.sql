  ...
  if v_action = 'aprobar' then
    ...
    set estado = 'pagado',
        ...
        metadata = coalesce(metadata, '{}'::jsonb) || jsonb_build_object(
          ...
          'procesado_at', now(),
          'manual_payment_atomic_version', 'v43'
        )
...
comment on function public.eos_process_manual_payment_v42(uuid, text, text) is
  'RC1 v43: pago manual atómico/idempotente con row lock y conflicto cerrado de referencia externa; plan, solicitud e historial se comprometen juntos.';