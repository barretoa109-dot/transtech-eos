...
begin
  ...
  -- Canonical decimal representation prevents aliases such as 1 / 01 / 001
  -- from representing the same execution order as different request IDs.
  ...
  if found then
    ...
    -- Exact replay: the already-audited proposal remains canonical.
    return null;
  end if;
