-- La rama de REGISTRAR_TRANSFERENCIA en el ejecutor.
--
-- Se genera desde el archivo de la v136 con tres cambios y nada más:
--
--   1. 'REGISTRAR_TRANSFERENCIA' entra en la lista de soportadas.
--   2. La rama nueva, que delega en
--      `eos_finanzas_registrar_transferencia_v138`.
--   3. `executor_version` pasa a 'v138'.
--
-- El porqué está en la cabecera de
-- `20260908040000_eos_transferencias_v138.sql`: mover plata de un banco a
-- otro se contaba como gasto Y como ingreso, y todo lo que se calcula sobre
-- esas dos columnas heredaba el error.
