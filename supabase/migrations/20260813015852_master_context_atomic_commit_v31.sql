...
revoke all on function public.eos_commit_master_context_v31(
  uuid, text, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb,
  jsonb, text, text, jsonb, jsonb, integer
) from public, anon;

grant execute on function public.eos_commit_master_context_v31(
  uuid, text, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb,
  jsonb, text, text, jsonb, jsonb, integer
) to authenticated;
...
comment on function public.eos_commit_master_context_v31(
  uuid, text, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb,
  jsonb, text, text, jsonb, jsonb, integer
) is 'RC1 v31: commit atomico, idempotente y serializado del Contexto Maestro; version y run se persisten en la misma transaccion.';
