-- La rama de REGISTRAR_OPORTUNIDAD en el ejecutor.
--
-- Se genera desde el archivo de la v153 con tres cambios y nada más:
--
--   1. La acción entra en la lista de soportadas.
--   2. La rama nueva.
--   3. `executor_version` pasa a 'v154'.
--
-- El porqué está en la cabecera de
-- `20260910120000_eos_oportunidad_por_chat_v154.sql`: el embudo está
-- construido y probado desde el 26 de agosto y se llena a mano, y es la
-- información que más se pierde — una oportunidad nace en una conversación y
-- si no se anota ahí no queda en ningún lado.
