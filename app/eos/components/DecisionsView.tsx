...
export default function DecisionsView() {
  ...
  return (
    <main className="decisions-page">
      ...
      <style jsx>{`
        .decisions-page{min-height:100%;padding:38px 28px 70px;background:radial-gradient(circle at 85% 8%,rgba(37,99,235,.11),transparent 28%),linear-gradient(145deg,#ffffff 0%,#f7faff 52%,#eef5ff 100%);color:#071226;font-family:var(--font-inter),Inter,Arial,Helvetica,sans-serif}.decisions-container{max-width:1180px;margin:auto}.decisions-header{display:flex;justify-content:space-between;gap:24px;align-items:flex-start}.eyebrow{display:flex;gap:8px;align-items:center;color:#1656bd;font-size:11px;font-weight:900;letter-spacing:.14em}.decisions-header h1{margin:12px 0 8px;font-size:38px;font-weight:900;letter-spacing:-.04em}.decisions-header p{max-width:680px;margin:0;color:#64748b;line-height:1.6}.header-actions,.form-actions{display:flex;gap:10px}.primary,.secondary,.result-button{display:inline-flex;align-items:center;justify-content:center;gap:8px;border:0;border-radius:12px;padding:12px 16px;font-family:inherit;font-weight:800;cursor:pointer}.primary{background:#1656bd;color:#fff;box-shadow:0 14px 30px rgba(37,99,235,.2)}.primary:hover{background:#113f8c}.secondary{border:1px solid #e9f0fb;background:rgba(255,255,255,.9);color:#1656bd;box-shadow:0 9px 24px rgba(37,99,235,.08)}.stats{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin:30px 0}.editor,.decision-card,.empty{border:1px solid rgba(148,163,184,.2);border-radius:20px;background:rgba(255,255,255,.92);box-shadow:0 17px 48px rgba(15,23,42,.065);padding:22px}.editor{margin-bottom:18px}.editor h2{margin:0 0 18px;color:#071226;font-weight:900}.form-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.form-grid label{display:grid;gap:7px;color:#475569;font-size:13px;font-weight:700}.wide{grid-column:1/-1}.form-grid input,.form-grid textarea,.result-form input,.result-form select{box-sizing:border-box;width:100%;border:1px solid #e9f0fb;border-radius:11px;background:#f8fbff;color:#071226;padding:12px;font:inherit}.form-grid input:focus,.form-grid textarea:focus,.result-form input:focus,.result-form select:focus{border-color:#2f72d6;outline:3px solid rgba(37,99,235,.1)}.form-grid textarea{min-height:86px;resize:vertical}.form-actions{justify-content:flex-end;margin-top:18px}.error{margin-bottom:16px;border:1px solid #fecaca;border-radius:12px;background:#fef2f2;color:#b91c1c;padding:13px 16px}.decision-list{display:grid;gap:15px}.empty{display:grid;justify-items:center;gap:8px;padding:44px;color:#64748b;text-align:center}.empty strong{color:#071226}.card-top{display:flex;justify-content:space-between;gap:18px}.card-top h2{margin:9px 0 0;color:#071226;font-size:21px;font-weight:900}.status{border-radius:999px;background:#e9f0fb;color:#1656bd;padding:5px 8px;font-size:10px;font-weight:850;letter-spacing:.12em;text-transform:uppercase}.date{display:flex;align-items:center;gap:6px;color:#64748b;font-size:12px}.decision-text{color:#334155;line-height:1.6}.details{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:16px 0}.details>div{border:1px solid #e2e8f0;border-radius:12px;background:#f8fbff;padding:13px}.details small,.latest small{color:#1656bd;font-size:10px;font-weight:900;letter-spacing:.12em}.details p,.latest p{margin:7px 0 0;color:#475569;line-height:1.5}.latest{display:flex;justify-content:space-between;gap:16px;margin-top:12px;border-left:3px solid #1656bd;border-radius:10px;background:#eef3fb;padding:14px}.latest span{display:block;margin-top:7px;color:#113f8c;font-size:12px}.latest>strong{color:#1656bd;font-size:26px}.result-positivo{border-left-color:#22c55e;background:#ecfdf5}.result-negativo{border-left-color:#ef4444;background:#fef2f2}.result-form{display:grid;grid-template-columns:140px 1.3fr 1fr auto;gap:8px;margin-top:14px}.result-button{margin-top:14px;border:1px solid #a9c6ee;background:#eef3fb;color:#1656bd;padding:9px 12px}.stat{border:1px solid rgba(148,163,184,.2);border-radius:16px;background:rgba(255,255,255,.92);box-shadow:0 14px 38px rgba(15,23,42,.055);padding:18px}@media(max-width:800px){.decisions-page{padding:26px 16px 60px}.decisions-header{display:grid}.header-actions{width:100%}.header-actions button{flex:1}.stats,.form-grid,.details{grid-template-columns:1fr}.wide{grid-column:auto}.result-form{grid-template-columns:1fr}.decisions-header h1{font-size:30px}.card-top{display:grid}.date{justify-self:start}}
      `}</style>
    </main>
  );
}
...
function Stat({ label, value, icon }: { label: string; value: number; icon: React.ReactNode }) {
  return <article className="stat"><span>{icon}</span><strong>{value}</strong><small>{label}</small><style jsx>{`.stat{display:grid;grid-template-columns:auto 1fr;column-gap:12px;align-items:center}.stat span{grid-row:1/3;color:#1656bd}.stat strong{color:#071226;font-size:25px;font-weight:900}.stat small{color:#64748b}`}</style></article>;
}
