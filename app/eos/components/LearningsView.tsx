...
export default function LearningsView() {
  ...
  return (
    <main className="learning-page">
      ...
      <style jsx>{`
        .learning-page{min-height:100%;padding:38px 28px 70px;background:radial-gradient(circle at 82% 8%,rgba(37,99,235,.11),transparent 28%),linear-gradient(145deg,#ffffff 0%,#f7faff 52%,#eef5ff 100%);color:#071226;font-family:var(--font-inter),Inter,Arial,Helvetica,sans-serif}.learning-container{max-width:1180px;margin:auto}.learning-header{display:flex;justify-content:space-between;gap:24px;align-items:flex-start}.eyebrow{display:flex;align-items:center;gap:8px;color:#1656bd;font-size:11px;font-weight:900;letter-spacing:.14em}.learning-header h1{margin:12px 0 8px;font-size:38px;font-weight:900;letter-spacing:-.04em}.learning-header p{max-width:710px;margin:0;color:#64748b;line-height:1.6}.refresh{display:flex;align-items:center;gap:8px;border:1px solid #e9f0fb;border-radius:12px;background:rgba(255,255,255,.9);color:#1656bd;padding:12px 16px;font-family:inherit;font-weight:800;box-shadow:0 9px 24px rgba(37,99,235,.08);cursor:pointer}.refresh:disabled{opacity:.65;cursor:wait}.metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin:30px 0}.error{margin-bottom:18px;border:1px solid #fecaca;border-radius:12px;background:#fef2f2;color:#b91c1c;padding:13px 16px}.collecting-card{display:grid;grid-template-columns:auto 1fr;gap:20px;border:1px solid rgba(148,163,184,.2);border-radius:22px;background:rgba(255,255,255,.92);box-shadow:0 20px 60px rgba(15,23,42,.07);padding:28px}.collecting-icon{display:grid;place-items:center;width:58px;height:58px;border-radius:17px;background:#eef3fb;color:#1656bd}.collecting-copy>span,.recommendation small{font-size:10px;font-weight:900;letter-spacing:.13em;color:#1656bd}.collecting-copy h2{margin:8px 0;color:#071226;font-size:22px;font-weight:900}.collecting-copy p{max-width:760px;color:#64748b;line-height:1.55}.progress-track{height:8px;margin:18px 0 8px;border-radius:999px;background:#e9eff8;overflow:hidden}.progress-track div{height:100%;border-radius:inherit;background:linear-gradient(90deg,#1656bd,#2f72d6);box-shadow:0 0 18px rgba(37,99,235,.3)}.collecting-copy small{color:#94a3b8}.learning-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.learning-card{border:1px solid rgba(148,163,184,.2);border-radius:20px;background:rgba(255,255,255,.92);box-shadow:0 17px 48px rgba(15,23,42,.065);padding:22px}.card-heading{display:flex;justify-content:space-between;gap:12px;align-items:center}.trend{display:flex;align-items:center;gap:7px;border-radius:999px;padding:6px 10px;background:#f1f5f9;color:#475569;font-size:11px;font-weight:900;text-transform:uppercase}.trend-positiva{background:#ecfdf5;color:#15803d}.trend-negativa{background:#fef2f2;color:#dc2626}.confidence{color:#64748b;font-size:12px}.category{display:block;margin-top:18px;color:#1656bd;font-size:10px;font-weight:900;letter-spacing:.13em;text-transform:uppercase}.learning-card h2{margin:8px 0 17px;color:#071226;font-size:20px;font-weight:900;line-height:1.4}.recommendation{border-left:3px solid #1656bd;border-radius:8px;background:#eef3fb;padding:13px 15px}.recommendation p{margin:7px 0 0;color:#475569;line-height:1.55}.learning-card footer{display:flex;flex-wrap:wrap;gap:12px;margin-top:16px;color:#64748b;font-size:11px}.metric{border:1px solid rgba(148,163,184,.2);border-radius:16px;background:rgba(255,255,255,.92);box-shadow:0 14px 38px rgba(15,23,42,.055);padding:18px}@media(max-width:850px){.learning-page{padding:26px 16px 60px}.learning-header{display:grid}.refresh{width:100%;justify-content:center}.metrics{grid-template-columns:repeat(2,1fr)}.learning-list{grid-template-columns:1fr}.learning-header h1{font-size:30px}.collecting-card{grid-template-columns:1fr}}@media(max-width:480px){.metrics{grid-template-columns:1fr}}
      `}</style>
    </main>
  );
}
