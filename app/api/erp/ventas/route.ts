...
export async function GET(request: Request) {
  ...
  /*
   * La empresa se resuelve UNA vez, antes de la consulta.
   *
   * El filtro incluye las dos fronteras —usuario y empresa— mientras dure la
   * transición de la v109/v110. Solo empresa haría desaparecer, sin ningún
   * error, una fila con la columna en null; solo usuario dejaría afuera a un
   * segundo miembro. Ver `lib/empresa/acceso.ts`.
   */
